...
//     : !str
//         .split('.')
//         .some(el => !/^\d+$/.test(el) || +el > 255 || +el < 0 || (el.length > 1 && el.startsWith('0')));
...
// -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// const points = gs => gs.reduce((acc, g) => (+g[0] > +g[2] ? acc + 3 : +g[0] === +g[2] ? acc + 1 : acc), 0);
// console.log(['1:0', '2:0', '3:0', '4:0', '2:1', '3:1', '4:1', '3:2', '4:2', '4:3']);
// -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
